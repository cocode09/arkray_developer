 ...
 *
 * Verbatim port of arkray.co.jp/english/policy/index.html — uses the original
 ...
 * matches without drift. Body content lives in parts/privacy-policy-content.php.
 *
...
<body class="arkray-inner arkray-privacy-page">
<?php wp_body_open(); ?>
	...
	<div id="content_area">
		<div id="editor_area">
			...
			if ( '' === trim( (string) $page_title ) ) {
				$page_title = arkray_t( 'Privacy Policy' );
			}
			?>
			...
			if ( '' !== $post_body ) {
				...
				include get_stylesheet_directory() . '/parts/privacy-policy-content.php';
			}
			?>
		</div>
	</div>
