...
$(function(){
	...
	var marker_icon = new Array('https://www.arkray.global/english/common/img/maker_red.png', 'https://www.arkray.global/english/common/img/maker_orange.png', 'https://www.arkray.global/english/common/img/maker_green.png', 'https://www.arkray.global/english/common/img/maker_blue.png');
	//マーカーの情報
	// 本社・管理拠点
	data1 = new Array();
	data1.push({
	...
	data1.push({
		lat: '35.006019',
		lng: '135.759293',
		url: '/about/group02/#UniversalHealthwareInc',
	...
	data1.push({
		lat: '35.687269',
		lng: '139.728018',
		url: '/about/group02/#ARKRAYMarketingInc',
	...
	data1.push({
		lat: '35.036799',
		lng: '135.756143',
		url: '/about/group02/#ARKRAYGlobalBusinessInc',
	...
	data1.push({
		lat: '1.317230',
		lng: '103.843576',
		url: '/about/group03/#ARKRAYPARTNERS',
	...
	data1.push({
		lat: '44.866484',
		lng: '-93.355606',
		url: '/about/group05/#ARKRAYAmericaInc',
	...
	data2.push({
		lat: '35.036799',
		lng: '135.756443',
		url: '/about/group02/#ARKRAYIncKyotoLaboratory',
		title: 'ARKRAY, Inc. Kyoto Laboratory'
	});
	data2.push({
		lat: '32.74732359594623',
		lng: '129.87483531211208',
		url: '/about/group02/#ARKRAYNagasaki',
		title: 'ARKRAY Nagasaki Development Center, Inc.'
	});
	data2.push({
		lat: '1.303987',
		lng: '103.792567',
		url: '/about/group03/#ARKRAYPARTNERSPteLtdSingaporeLaboratory',
		title: 'ARKRAY&PARTNERS Pte.Ltd. Singapore Laboratory'
	});
	data2.push({
		lat: '37.349523',
		lng: '126.953490',
		url: '/about/group03/#ARKRAYGlobalBusinessIncKoreanDevelopmentCenter',
		title: 'ARKRAY Global Business, Inc. Korean Development Center',
	});
	data2.push({
		lat: '18.593928',
		lng: '73.757249',
		url: '/about/group03/#ARKRAYHealthcarePvtLtd',
	...
	data2.push({
		lat: '34.6890813',
		lng: '135.4953552',
		url: '/about/group02/#OsakaDevelopmentCenter',
	...
	data3.push({
		lat: '34.895600',
		lng: '136.171004',
		url: '/about/group02/#ARKRAYFactoryInc',
		title: 'ARKRAY Factory, Inc.'
	});
	data3.push({
		lat: '30.737305',
		lng: '121.009245',
		url: '/about/group03/#ARKRAYFactoryPinghu',
		title: 'ARKRAY Factory Pinghu, Inc.'
	});
	data3.push({
		lat: '14.134091',
		lng: '121.133976',
		url: '/about/group03/#ARKRAYIndustryInc',
		title: 'ARKRAY Industry, Inc.'
	});
	data3.push({
		lat: '14.408576',
		lng: '120.864767',
		url: '/about/group03/#ARKRAYIndustryWestInc',
		title: 'ARKRAY Industry West, Inc.'
	});
	data3.push({
		lat: '21.092560',
		lng: '72.852264',
		url: '/about/group03/#ARKRAYHealthcarePvtLtdSurat',
	...
	data3.push({
		lat: '44.866634',
		lng: '-93.356620',
		url: '/about/group05/#ARKRAYFactoryUSAInc',
		title: 'ARKRAY Factory USA, Inc.'
	});
	data3.push({
		lat: '53.459302',
		lng: '-6.211069',
		url: '/about/group04/#ARKRAYIrelandLtd',
	...
	data4.push({
		lat: '34.895600',
		lng: '136.171004',
		url: '/about/group02/#ARKRAYInfinityInc',
		title: 'ARKRAY Infinity, Inc.'
	});
	data4.push({
		lat: '35.036799',
		lng: '135.756443',
		url: '/about/group02/#KaradaLabInc',
		title: 'Karada Lab, Inc.'
	});
	data4.push({
		lat: '31.19137',
		lng: '121.4215451',
		url: '/about/group03/#ARKRAYMarketingShanghaiInc',
		title: 'ARKRAY Marketing Shanghai, Inc.'
	});
	data4.push({
		lat: '39.905689',
		lng: '116.450677',
		url: '/about/group03/#ARKRAYMarketingShanghaiBeijingSalesandServiceOffice',
		title: 'ARKRAY Marketing Shanghai, Inc. Beijing Sales and Service Office'
	});
	data4.push({
		lat: '37.520065',
		lng: '126.930759',
		url: '/about/group03/#ARKRAYGlobalBusinessIncSeoulSalesandServiceOffice',
	...
	data4.push({
		lat: '-6.213130',
		lng: '106.831048',
		url: '/about/group03/#PTARKRAY',
		title: 'PT. ARKRAY'
	});
	data4.push({
		lat: '14.416408',
		lng: '121.043926',
		url: '/about/group03/#ARKRAYCoLtdInc',
	...
	data4.push({
		lat: '52.318536',
		lng: '4.871327',
		url: '/about/group04/#ARKRAYEuropeBV',
		title: 'ARKRAY Europe, B.V.'
	});
	data4.push({
		lat: '44.866484',
		lng: '-93.355606',
		url: '/about/group05/#ARKRAYUSAInc',
		title: 'ARKRAY USA, Inc.'
	});
	data4.push({
		lat: '44.866484',
		lng: '-93.355606',
		url: '/about/group05/#USARKRAYInc',
		title: 'U.S.ARKRAY, Inc.'
	});
	data4.push({
		lat: '25.812239',
		lng: '-80.362822',
		url: '/about/group05/#ARKRAYUSAIncMiamibranch',
		title: 'ARKRAY USA, Inc. Miami branch'
	});
	data4.push({
		lat: '21.050117',
		lng: '105.782285',
		url: '/about/group03/#ArkrayVietnamCoLtd',
		title: 'Arkray Vietnam Co., Ltd.'
	});
	data4.push({
		lat: '51.660508',
		lng: '-0.915205',
		url: '/about/group04/#ARKRAYLtd',
		title: 'ARKRAY Ltd.'
	});
	data4.push({
		lat: '45.600654',
		lng: '9.361161',
		url: '/about/group04/#ARKRAYItaliaSRL',
		title: 'ARKRAY Italia S.R.L.'
	});
	data4.push({
		lat: '41.372886',
		lng: '2.078611',
		url: '/about/group04/#ARKRAYEspanaSAU',
		title: 'ARKRAY España S.A.U.'
	});
	data4.push({
		lat: '38.708140',
		lng: '-9.1432421',
		url: '/about/group04/#ARKRAYEspanaSAUPortugalBranch',
		title: 'ARKRAY España S.A.U. Portugal Branch'
	});
	data4.push({
		lat: '50.846557',
		lng: '4.359621',
		url: '/about/group04/#ARKRAYEuropeBVARKRAYBelgiumBranch',
		title: 'ARKRAY Europe, B.V. ARKRAY Belgium Branch'
	});
	data4.push({
		lat: '19.395444',
		lng: '-99.171727',
		url: '/about/group05/#ARKRAYLabMexicoSAdeCV',
		title: 'ARKRAY Lab Mèxico, S.A. de C.V.'
	});
	data4.push({
		lat: '13.727034779374558',
		lng: '100.57816186013945',
		url: '/about/group03/#ARKRAYThailandCoLtd',
